...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000016 -R local  -L rack-4x -T 2026-01-27T10:45:04+00:00 /app/simulations/rack_resiliency_sim.py node-failure w3 --stabilization-time=3
job_ec=$?
