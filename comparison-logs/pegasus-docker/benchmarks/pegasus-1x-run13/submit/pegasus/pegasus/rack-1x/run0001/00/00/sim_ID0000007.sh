...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000007 -R local  -L rack-1x -T 2026-01-27T08:50:47+00:00 /app/simulations/rack_resiliency_sim.py health-check --stabilization-time=2
job_ec=$?
