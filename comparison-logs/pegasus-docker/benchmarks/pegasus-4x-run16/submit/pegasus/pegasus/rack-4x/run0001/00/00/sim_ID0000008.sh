...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000008 -R local  -L rack-4x -T 2026-01-27T10:50:27+00:00 /app/simulations/rack_resiliency_sim.py health-check --stabilization-time=2
job_ec=$?
