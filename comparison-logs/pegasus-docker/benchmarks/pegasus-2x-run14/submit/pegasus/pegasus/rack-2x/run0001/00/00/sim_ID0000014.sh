...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000014 -R local  -L rack-2x -T 2026-01-27T09:47:04+00:00 /app/simulations/rack_resiliency_sim.py health-check --stabilization-time=2
job_ec=$?
