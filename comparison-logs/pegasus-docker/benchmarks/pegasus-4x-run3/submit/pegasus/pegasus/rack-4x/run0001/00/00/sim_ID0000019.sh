...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000019 -R local  -L rack-4x -T 2026-01-27T10:12:17+00:00 /app/simulations/rack_resiliency_sim.py health-check --stabilization-time=2
job_ec=$?
