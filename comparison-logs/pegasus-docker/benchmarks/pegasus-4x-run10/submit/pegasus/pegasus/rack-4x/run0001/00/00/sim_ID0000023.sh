...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000023 -R local  -L rack-4x -T 2026-01-27T10:32:48+00:00 /app/simulations/rack_resiliency_sim.py rack-failure R2 --stabilization-time=3
job_ec=$?
