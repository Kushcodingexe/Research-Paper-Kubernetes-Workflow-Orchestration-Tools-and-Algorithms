...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000003 -R local  -L rack-1x -T 2026-01-27T08:58:09+00:00 /app/simulations/rack_resiliency_sim.py health-check --stabilization-time=2
job_ec=$?
