...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000024 -R local  -L rack-4x -T 2026-01-27T11:01:54+00:00 /app/simulations/rack_resiliency_sim.py rack-failure R3 --stabilization-time=3
job_ec=$?
