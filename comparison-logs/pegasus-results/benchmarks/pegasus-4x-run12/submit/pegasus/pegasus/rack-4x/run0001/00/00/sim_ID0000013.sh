...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000013 -R local  -L rack-4x -T 2026-01-27T10:39:11+00:00 /app/simulations/rack_resiliency_sim.py node-failure w0 --stabilization-time=3
job_ec=$?
