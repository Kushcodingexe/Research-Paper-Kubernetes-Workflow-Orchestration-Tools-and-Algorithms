...
pegasus-kickstart  -n rack::sim:1.0 -N ID0000011 -R local  -L rack-2x -T 2026-01-27T09:29:24+00:00 /app/simulations/rack_resiliency_sim.py rack-failure R0 --stabilization-time=3
job_ec=$?
