...
pegasus-kickstart  -n rack::health-check:1.0 -N ID0000001 -o out1.txt -R local  -s out1.txt=out1.txt -L test-workflow -T 2026-01-26T11:18:57+00:00 /app/simulations/rack_resiliency_sim.py health-check --stabilization-time=2
job_ec=$?
