...
pegasus-kickstart  -n rack_resiliency::node-failure-sim:1.0 -N ID0000004 -R local  -s node-sim-1.log=node-sim-1.log -L rack-resiliency-1x-20260125-093729 -T 2026-01-25T09:37:29+05:30 /home/snu/kubernetes/Automation_Scripts/rack_resiliency_to_host.py node-failure worker-w001 --stabilization-time=30
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "file://$PWD/node-sim-1.log", "checkpoint": "false" }
   ],
   "dest_urls": [
     { "site_label": "local", "url": "file:///tmp/pegasus-scratch/snu/pegasus/rack-resiliency-1x-20260125-093729/run0001/00/00/node-sim-1.log" }
   ] }
]
eof
