...
pegasus-kickstart  -n rack_resiliency::health-check:1.0 -N ID0000002 -R local  -s health-check-2.log=health-check-2.log -L rack-resiliency-1x-20260125-093729 -T 2026-01-25T09:37:29+05:30 /home/snu/kubernetes/Automation_Scripts/rack_resiliency_to_host.py health-check --stabilization-time=10
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///tmp/pegasus-scratch/snu/pegasus/rack-resiliency-1x-20260125-093729/run0001/00/00/health-check-2.log" }
   ] }
]
eof
