...
pegasus-kickstart  -n rack_resiliency::rack-failure-sim:1.0 -N ID0000006 -R local  -s rack-sim-1.log=rack-sim-1.log -L rack-resiliency-1x-20260122-101553 -T 2026-01-22T10:15:53+05:30 /home/snu/kubernetes/Automation_Scripts/rack_resiliency_to_host.py rack-failure R1 --stabilization-time=30
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///tmp/pegasus-scratch/snu/pegasus/rack-resiliency-1x-20260122-101553/run0001/00/00/rack-sim-1.log" }
   ] }
]
eof
