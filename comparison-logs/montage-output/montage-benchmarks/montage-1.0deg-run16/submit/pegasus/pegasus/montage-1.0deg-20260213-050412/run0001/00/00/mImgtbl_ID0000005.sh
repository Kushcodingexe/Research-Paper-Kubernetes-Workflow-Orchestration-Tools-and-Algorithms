...
pegasus-kickstart  -n montage::mImgtbl:6.0 -N ID0000005 -R local  -s images.tbl=images.tbl -L montage-1.0deg-20260213-050412 -T 2026-02-13T05:04:12+00:00 /app/executables/mImgtbl.py -t 4 images.tbl
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-050412/run0001/00/00/images.tbl" }
   ] }
]
eof
