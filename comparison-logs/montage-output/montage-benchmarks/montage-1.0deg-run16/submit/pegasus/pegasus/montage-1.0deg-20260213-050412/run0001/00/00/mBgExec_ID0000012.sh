...
pegasus-kickstart  -n montage::mBgExec:6.0 -N ID0000012 -R local  -s corrected_002.fits=corrected_002.fits -L montage-1.0deg-20260213-050412 -T 2026-02-13T05:04:12+00:00 /app/executables/mBgExec.py projected_002.fits corrections.tbl corrected_002.fits
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-050412/run0001/00/00/corrected_002.fits" }
   ] }
]
eof
