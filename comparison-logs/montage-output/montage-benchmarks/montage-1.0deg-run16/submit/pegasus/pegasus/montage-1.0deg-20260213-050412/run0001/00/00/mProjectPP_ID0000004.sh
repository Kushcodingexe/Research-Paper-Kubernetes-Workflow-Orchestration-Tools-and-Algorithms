...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-050412/run0001/00/00/input_004.fits", "checkpoint": "false" }
   ],
   "dest_urls": [
...
pegasus-kickstart  -n montage::mProjectPP:6.0 -N ID0000004 -R local  -s projected_004.fits=projected_004.fits -L montage-1.0deg-20260213-050412 -T 2026-02-13T05:04:12+00:00 /app/executables/mProjectPP.py -X input_004.fits projected_004.fits
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-050412/run0001/00/00/projected_004.fits" }
   ] }
]
eof
