...
pegasus-kickstart  -n montage::mBgExec:6.0 -N ID0000011 -R local  -s corrected_001.fits=corrected_001.fits -L montage-1.0deg-20260213-050412 -T 2026-02-13T05:04:12+00:00 /app/executables/mBgExec.py projected_001.fits corrections.tbl corrected_001.fits
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-050412/run0001/00/00/corrected_001.fits" }
   ] }
]
eof
