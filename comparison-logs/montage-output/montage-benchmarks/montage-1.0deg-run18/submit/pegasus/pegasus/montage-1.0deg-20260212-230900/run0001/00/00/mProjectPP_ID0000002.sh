...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260212-230900/run0001/00/00/input_002.fits", "checkpoint": "false" }
   ],
   "dest_urls": [
...
pegasus-kickstart  -n montage::mProjectPP:6.0 -N ID0000002 -R local  -s projected_002.fits=projected_002.fits -L montage-1.0deg-20260212-230900 -T 2026-02-12T23:09:00+00:00 /app/executables/mProjectPP.py -X input_002.fits projected_002.fits
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260212-230900/run0001/00/00/projected_002.fits" }
   ] }
]
eof
