...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-045838/run0001/00/00/input_001.fits", "checkpoint": "false" }
   ],
   "dest_urls": [
...
pegasus-kickstart  -n montage::mProjectPP:6.0 -N ID0000001 -R local  -s projected_001.fits=projected_001.fits -L montage-1.0deg-20260213-045838 -T 2026-02-13T04:58:38+00:00 /app/executables/mProjectPP.py -X input_001.fits projected_001.fits
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-045838/run0001/00/00/projected_001.fits" }
   ] }
]
eof
