...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-045838/run0001/00/00/fits.tbl", "checkpoint": "false" }
   ],
   "dest_urls": [
 ...
 { "type": "transfer",
   ...
   "id": 2,
   "src_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-045838/run0001/00/00/images.tbl", "checkpoint": "false" }
   ],
   "dest_urls": [
...
pegasus-kickstart  -n montage::mBgModel:6.0 -N ID0000010 -R local  -s corrections.tbl=corrections.tbl -L montage-1.0deg-20260213-045838 -T 2026-02-13T04:58:38+00:00 /app/executables/mBgModel.py images.tbl fits.tbl corrections.tbl
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-045838/run0001/00/00/corrections.tbl" }
   ] }
]
eof
