...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260212-212123/run0001/00/00/mosaic.fits", "checkpoint": "false" }
   ],
   "dest_urls": [
...
pegasus-kickstart  -n montage::mShrink:6.0 -N ID0000016 -R local  -s mosaic_thumb.fits=mosaic_thumb.fits -L montage-1.0deg-20260212-212123 -T 2026-02-12T21:21:23+00:00 /app/executables/mShrink.py mosaic.fits mosaic_thumb.fits 0.1
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260212-212123/run0001/00/00/mosaic_thumb.fits" }
   ] }
]
eof
