...
pegasus-kickstart  -n montage::mJPEG:6.0 -N ID0000017 -R local  -s mosaic.jpg=mosaic.jpg -L montage-1.0deg-20260212-212123 -T 2026-02-12T21:21:23+00:00 /app/executables/mJPEG.py mosaic.fits mosaic.jpg
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260212-212123/run0001/00/00/mosaic.jpg" }
   ] }
]
eof
