...
pegasus-kickstart  -n montage::mDiffFit:6.0 -N ID0000006 -R local  -s diff_001.fits=diff_001.fits -s fit_001.txt=fit_001.txt -L montage-1.0deg-20260213-050639 -T 2026-02-13T05:06:39+00:00 /app/executables/mDiffFit.py projected_001.fits projected_002.fits diff_001.fits fit_001.txt
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-050639/run0001/00/00/diff_001.fits" }
   ] }
 ,
 { "type": "transfer",
   "linkage": "output",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-050639/run0001/00/00/fit_001.txt" }
   ] }
]
eof
