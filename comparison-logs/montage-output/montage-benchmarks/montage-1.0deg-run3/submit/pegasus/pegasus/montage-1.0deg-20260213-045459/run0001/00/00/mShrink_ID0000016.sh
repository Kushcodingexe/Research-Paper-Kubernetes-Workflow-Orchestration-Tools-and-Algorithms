...
[
 { "type": "transfer",
   ...
   "id": 1,
   "src_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-045459/run0001/00/00/mosaic.fits", "checkpoint": "false" }
   ],
   "dest_urls": [
...
pegasus-kickstart  -n montage::mShrink:6.0 -N ID0000016 -R local  -s mosaic_thumb.fits=mosaic_thumb.fits -L montage-1.0deg-20260213-045459 -T 2026-02-13T04:54:59+00:00 /app/executables/mShrink.py mosaic.fits mosaic_thumb.fits 0.1
job_ec=$?
...
[
 { "type": "transfer",
   ...
   "dest_urls": [
     { "site_label": "local", "url": "file:///app/scratch/pegasus/pegasus/montage-1.0deg-20260213-045459/run0001/00/00/mosaic_thumb.fits" }
   ] }
]
eof
